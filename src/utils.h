...
inline glm::vec3 computeNormal(const glm::vec3 &p1, const glm::vec3 &p2,
                               const glm::vec3 &p3) {
  glm::vec3 v12 = p2;
  v12 -= p1;
  glm::vec3 v23 = p3;
...
inline double AreaOfTriangle(const glm::vec3 &a, const glm::vec3 &b,
                             const glm::vec3 &c) {
  return AreaOfTriangle(glm::length(a - b), glm::length(b - c),
                        glm::length(c - a));
}
